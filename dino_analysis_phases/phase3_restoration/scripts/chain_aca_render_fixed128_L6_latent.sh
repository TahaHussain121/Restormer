...
#SBATCH --export=NONE
#SBATCH --job-name=p3chain_acaL6
#SBATCH --output=dino_analysis_phases/phase3_restoration/results/Holo_aca_render_fixed128_L6_latent/logs/chain_%j.out
#
# =============================================================================
# Self-chaining resume driver for ONE experiment: Holo_aca_render_fixed128_L6_latent
#
#     sbatch dino_analysis_phases/phase3_restoration/scripts/chain_aca_render_fixed128_L6_latent.sh
#
...
CONFIG=/home/woody/iwnt/iwnt174h/thesis_dino/code/Restormer/dino_analysis_phases/phase3_restoration/configs/aca_render_fixed128_L6_latent.yml
SELF=/home/woody/iwnt/iwnt174h/thesis_dino/code/Restormer/dino_analysis_phases/phase3_restoration/scripts/chain_aca_render_fixed128_L6_latent.sh
ARM_PART=a100
ARM_GRES=gpu:a100:1
JOB_LABEL="aca-L6 (render, B6 only, ACA fusion -- the one-factor operator ablation)"
